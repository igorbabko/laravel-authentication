...
<body class="min-h-screen bg-gray-50">
    <svg class="fixed bottom-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#4ca154" fill-opacity="1" d="M0,224L48,186.7C96,149,192,75,288,74.7C384,75,480,149,576,160C672,171,768,117,864,101.3C960,85,1056,107,1152,144C1248,181,1344,235,1392,261.3L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
    </svg>
    <header class="flex items-center justify-between p-6">
        <a href="register.html" class="flex items-center gap-2">
        ...
        <div>
            <a href="login.html" class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Sign In</a>
        </div>
    </header>
            ...
            <form action="#" autocomplete="off" class="space-y-6">
                <div>
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="text" id="name" name="name" required class="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="John Doe" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="email" id="email" name="email" class="w-full rounded-md border-red-300 pl-10 pr-10 text-sm text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500" placeholder="john@example.com" />
                ...
                <div>
                    <a href="verify-email.html" class="flex items-center justify-center rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Sign Up</a>
                </div>
            </form>
